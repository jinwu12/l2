...
--
-- Dumping data for table `realtime_signal_template`
--

LOCK TABLES `realtime_signal_template` WRITE;
/*!40000 ALTER TABLE `realtime_signal_template` DISABLE KEYS */;
/*!40000 ALTER TABLE `realtime_signal_template` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-20  5:54:34
